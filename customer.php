...
<body style="background: #f5f8fd;">
 ...
 <section class="clearfix">
  <div class="container d-flex h-100">
      <table  id="showTable" class="table" style="margin-top: 150px;">
      ...
      <tr>
            ...
            <td><button type="button" id=<?php echo $row['id']; ?> class="btn btn-primary" onclick= "trans(<?php echo $row['id'];?>)">View</i></button></td>
            <script>
              function trans(tid)
              {
               location.href = "transfer.php?cid="+tid;
              } 
            </script>
      </tr>
      <?php endwhile ?>
